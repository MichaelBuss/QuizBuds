...
class QuizCell: QBCell<Category> {
...
//        print(element.name!)
        ...
        cellLabel.textColor = UIColor(named: "element Label Color") ?? #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
    ...
    func populate(withelement element: Category){
